...
export function calculateClothingTransform(
  ...
  switch (category) {
    case 'tops':
      return calculateTopTransform(estimated, canvasWidth, canvasHeight);
    case 'bottoms':
      return calculateBottomTransform(estimated, canvasWidth, canvasHeight);
  }
}
...
export function getClothingQuad(
  ...
  if (anchorPoints && anchorPoints.leftShoulder && anchorPoints.rightShoulder) {
    ...
    return mapAnchorsToBody(estimated, category, anchorPoints, canvasWidth, canvasHeight);
  }
